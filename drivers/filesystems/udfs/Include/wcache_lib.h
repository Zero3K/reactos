...
#define WCACHE_NO_WRITE_THROUGH     0x00000020

#define WCACHE_VALID_FLAGS          (WCACHE_CACHE_WHOLE_PACKET | WCACHE_DO_NOT_COMPARE | WCACHE_CHAINED_IO | WCACHE_MARK_BAD_BLOCKS | WCACHE_RO_BAD_BLOCKS | WCACHE_NO_WRITE_THROUGH)
