...
// Work around the issue of using named structures in anonymous unions
...
// strictly enforces this. We use GCC diagnostic pragmas to selectively
// disable the pedantic warning for this header without breaking functionality.
